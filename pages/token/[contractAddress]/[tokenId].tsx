...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  console.log("Fetching token ID:", tokenId);

  const sdk = new ThirdwebSDK(NETWORK);
  console.log("Network:", NETWORK);

  const contract = await sdk.getContract(NFT_COLLECTION_ADDRESS, nftabi as any);
  console.log("Contract address:", NFT_COLLECTION_ADDRESS);
  ...
  try {
    ...
    console.log("NFT fetched:", nft);
    contractMetadata = await contract.metadata.get();
    console.log("Contract metadata:", contractMetadata);
  } catch (e) {
    console.error("Error fetching NFT or contract metadata:", e);
  }
...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  let nfts = [];
  try {
    nfts = await contract.erc721.getAll();
